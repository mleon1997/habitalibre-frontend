...
export default function SimuladorPage() {
  ...
  return (
    <div
      className={[
        // ✅ 100dvh evita problemas iOS con barras del navegador
        "min-h-[100dvh] bg-slate-950",
        // ✅ en móvil: flow natural + scroll (mejor con teclado)
        "flex items-start justify-center",
        // ✅ en desktop: sí lo centramos verticalmente
        "md:items-center",
        // ✅ padding móvil y safe area abajo (notch)
        "px-4 py-8 md:py-10",
    ...
    >
      <div
        className={[
          ...
          // ✅ si el wizard crece, que no rompa el viewport en móvil
          "overflow-hidden",
        ].join(" ")}
      >
